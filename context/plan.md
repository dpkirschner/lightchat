...
Goal: Establish the basic backend server, configuration, and initial provider interfaces.
    ...
    LC-004: Define Provider Abstraction & /providers Metadata Endpoint
        ...
        AC:
            LLMProvider abstract base class with specified methods defined.
            GET /providers endpoint implemented.
            Endpoint returns a JSON list, e.g., [{"id": "ollama_default", "name": "Ollama", "type": "local", "status": "configured"}].
